				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center max-w-6xl mx-auto">
					...
					>
						<h2 className="text-4xl font-bold text-card-foreground mb-6">
							Mobile Auto Detailing in Santa Clarita, CA
						</h2>
						<p className="text-muted-foreground mb-8 text-sm sm:text-base leading-relaxed">
							Professional mobile car detailing services throughout Santa
							Clarita Valley. We bring premium auto detailing directly to your
							home, office, or preferred location in Santa Clarita, Valencia,
							Canyon Country, and surrounding areas.
						</p>
					...
					>
						<div className="bg-muted rounded-lg p-4 sm:p-8 text-center transform hover:scale-105 transition-all duration-300 hover:shadow-xl">
							...
							<p className="text-muted-foreground text-sm sm:text-base">
								Mobile detailing service area covers Santa Clarita, Valencia,
								Canyon Country, Saugus, Newhall, and Stevenson Ranch
							</p>
						</div>
					</div>
				</div>
